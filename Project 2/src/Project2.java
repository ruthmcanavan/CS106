/**
 * A quiz to determine which Hogwarts house you are in
 */
	import java.util.*;
...
public class Project2 {
	 ...
	 * @param args
	 * @param bravery, trait of Gryffindor
	 * @param wisdom, trait of Ravenclaw
	 * @param loyalty, trait of Hufflepuff
	 * @param cunning, trait of Slytherin
	 */
	public static void main(String[] args) {
		...
		if (bravery > wisdom && cunning && loyalty) {
	 ...
	 } else if (cunning > bravery && wisdom && loyalty) {
